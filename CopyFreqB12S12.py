...
def system(w, t, p):
    ...
    #xB2.append((1-epsilon) * B2arr[0] + epsilon * B1arr[0])
    ...
    for i in np.arange(inx%d, inx, d):
        ...
        xB1.append((1-epsilon) * B1arr[i] + epsilon * B2arr[i] + S1arr[i] * xSb1[len(xSb1) - 1] )
        xB2.append((1-epsilon) * B2arr[i] + epsilon * B1arr[i] + S2arr[i] * xSb2[len(xSb2) - 1])
        if(xB1[len(xB1) - 1] != 0):
            xB1norm = pow(xB1[len(xB1) - 1], a)
        if (xB2[len(xB2) - 1] != 0):
            xB2norm = pow(xB2[len(xB2) - 1], a)
        ...
        fS1 = xSb1[len(xSb1)-1] * piB1(t) + xSb2[len(xSb2)-1] * piB2(t)
        fS1arr[inx] = fS1
        evaluated[inx] = 1
        fS2 = 0#xSb2[len(xSb2)-1] * piB2(t)
        fS2arr[inx] = fS2
    ...
    if t  < stoptime / 2:
#        f = np.array([(B1 * fB1 * Q[0][0] + B2 * fB2 * Q[1][0] + S1 * fS1 * Q[2][0] + S2 * fS2 * Q[3][0]) - B1 * phi + eta * B2, \
#                      (B1 * fB1 * Q[0][1] + B2 * fB2 * Q[1][1] + S1 * fS1 * Q[2][1] + S2 * fS2 * Q[3][1]) - B2 * phi - eta * B2, \
        f = np.array([(B1 * fB1 * Q[0][0] + B2 * fB2 * Q[1][0] + S1 * fS1 * Q[2][0] + S2 * fS2 * Q[3][0]) - B1 * phi, \
                      ...
                      (B1 * fB1 * Q[0][2] + B2 * fB2 * Q[1][2] + S1 * fS1 * Q[2][2] + S2 * fS2 * Q[3][3]) - S2 * phi])
    else:
#        f = np.array([(B1 * fB1 * Q[0][0] + B2 * fB2 * Q[1][0] + S1 * fS1 * Q[2][0] + S2 * fS2 * Q[3][0]) - B1 * phi - eta * B1, \
#                      (B1 * fB1 * Q[0][1] + B2 * fB2 * Q[1][1] + S1 * fS1 * Q[2][1] + S2 * fS2 * Q[3][1]) - B2 * phi + eta * B1, \
        f = np.array([(B1 * fB1 * Q[0][0] + B2 * fB2 * Q[1][0] + S1 * fS1 * Q[2][0] + S2 * fS2 * Q[3][0]) - B1 * phi, \
                      (B1 * fB1 * Q[0][1] + B2 * fB2 * Q[1][1] + S1 * fS1 * Q[2][1] + S2 * fS2 * Q[3][1]) - B2 * phi, \
                      (B1 * fB1 * Q[0][2] + B2 * fB2 * Q[1][2] + S1 * fS1 * Q[2][2] + S2 * fS2 * Q[3][2]) - S1 * phi, \
                      (B1 * fB1 * Q[0][2] + B2 * fB2 * Q[1][2] + S1 * fS1 * Q[2][2] + S2 * fS2 * Q[3][3]) - S2 * phi])
